...
<div class="card shadow-sm border-0 mx-auto" style="max-width: 500px;">
    <div class="card-body p-5">
        <div class="text-center mb-4">
            ...
            <h3 class="mb-1 fw-bold"><?= htmlspecialchars($mhs['nama']) ?></h3>
            <p class="text-muted mb-2"><?= htmlspecialchars($mhs['nim']) ?></p>
            ...
            <div class="mt-2">
                ...
                <?php else: ?>
                    <span class="badge bg-secondary px-3 py-2 fs-6"><?= htmlspecialchars($mhs['status']) ?></span>
                <?php endif; ?>
            </div>
        </div>
        ...
        <ul class="list-group list-group-flush mb-4">
            <li class="list-group-item d-flex justify-content-between align-items-center px-0 py-3">
                ...
                <span class="fw-medium"><?= htmlspecialchars($mhs['nim']) ?></span>
            </li>
            <li class="list-group-item d-flex justify-content-between align-items-center px-0 py-3">
            ...
            <li class="list-group-item d-flex justify-content-between align-items-center px-0 py-3">
                ...
                <span class="fw-medium"><?= htmlspecialchars($mhs['jurusan']) ?></span>
            </li>
            <li class="list-group-item d-flex justify-content-between align-items-center px-0 py-3 border-bottom-0">
                ...
                <span class="fw-medium"><?= htmlspecialchars($mhs['angkatan']) ?></span>
            </li>
        </ul>
        
        <div class="d-flex gap-2">
            <a href="edit.php?id=<?= $mhs['id'] ?>" class="btn btn-warning flex-grow-1 fw-medium">
                <i class="fa-solid fa-pen-to-square me-1"></i> Edit Profil
            </a>
            <a href="delete.php?id=<?= $mhs['id'] ?>" class="btn btn-danger flex-grow-1 fw-medium" onclick="return confirm('Apakah Anda yakin ingin menghapus data profil ini?')">
